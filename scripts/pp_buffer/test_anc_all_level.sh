...
CUDA_VISIBLE_DEVICES=${gpus} python ./exp/test_all_settings.py \
	       ...
	       --log_dir ./logs.buffer/TEST-${data}_${classes_per_it_val}way${num_support_val}shot_base0_anc1_chi0_ppbuffer_${training_strategy}_nhop${n_hop}_reset${reset_interval}/ --log_interval 20 --test_interval 100 \
